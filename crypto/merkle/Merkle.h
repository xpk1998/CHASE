...
#include "../../concepts/ByteBuffer.h"
#include "../../crypto/hasher/Hasher.h"
#include "../../utilities/Common.h"
#include "../../utilities/DataConvertUtility.h"
...
public:
        ...
        bcos::concepts::bytebuffer::Hash auto const& root)
    {
        ...
        {
            throw std::invalid_argument{"Empty input proof!"};
        }
        ...
        bcos::concepts::bytebuffer::Hash auto const& hash, ProofRange auto& out) const
    {
        ...
        {
            throw std::invalid_argument{"Not found hash!"}
        }
        ...
        std::integral auto index, ProofRange auto& out) const
    {
        ...
        {
            throw std::invalid_argument{"Merkle size mismatch!"};
        }
