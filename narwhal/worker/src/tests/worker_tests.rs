...
async fn get_network_peers_from_admin_server() {
    ...
    let worker_client_1 = WorkerNetworkClient::new_from_keypair(&authority_1.network_keypair());
    ...
    let worker_client_2 = WorkerNetworkClient::new_from_keypair(&authority_2.network_keypair());
    let primary_client_2 = PrimaryNetworkClient::new_from_keypair(&authority_2.network_keypair());
